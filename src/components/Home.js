    ...
    <div className="p-1 m-1">
      <div className="card">
        <div className="card-body">
          ...
          <div>
            <img src="businessman.png" alt="Homme d'affaires" style={{ width: '300px', height: '250px' }} />
            <img src="coatchSport.jpg" alt="Entraîneur sportif" style={{ width: '300px', height: '250px' }} />
            <img src="medecinDessin.png" alt="Médecin" style={{ width: '300px', height: '250px' }} />
          </div>
          <br /><br /><br /><br />
